...
namespace sn_Exception {
    ...
    namespace scope_exception_guard {
        ...
        // ref: CppCon15-AA-Declarive-Programming
...
#define SCOPE_EXIT \
    ...
    = sn_Exception::scope_exception_guard::ScopeGuardOnExit() + [&]()

#define SCOPE_FAIL \
    auto ANONYMOUS_VARIABLE(SCOPE_FAIL_STATE) \
    = sn_Exception::scope_exception_guard::ScopeGuardOnFailure() + [&]()

#define SCOPE_SUCCESS \
    auto ANONYMOUS_VARIABLE(SCOPE_SUCCESS_STATE) \
    = sn_Exception::scope_exception_guard::ScopeGuardOnSuccess() + [&]()
    ...
    namespace stack_walker {
        ...
        // TODO: ref: https://github.com/akemimadoka/NatsuLib/blob/master/NatsuLib/natStackWalker.cpp
...
//#if defined(_M_IX86) && (_WIN32_WINNT <= 0x0500) && (_MSC_VER < 1400)
    ...
    do { \
        ...
        public:
            ...
            StackWalker(
                StackWalkerOptions options = OptionsAll,
...
// Also display the OS-version
        ...
        private:
            ...
            using MODULEENTRY32 = tagMODULEENTRY32;
